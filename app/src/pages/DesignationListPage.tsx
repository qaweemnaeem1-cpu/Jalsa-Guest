...
export default function DesignationListPage() {
  ...
  const handleSaveEdit = (id: string) => {
    ...
    const exists = designations.some(d => 
      d.id !== id && d.name.toLowerCase() === editValue.trim().toLowerCase()
    );
    if (exists) {
      toast.error('This designation already exists');
      return;
                            ...
                            {editingId === designation.id ? (
                              <div className="flex-1 flex items-center gap-3">
                                ...
                                <Button
                                  ...
                                  className="text-green-600 hover:text-green-700 hover:bg-green-50 h-9 w-9 p-0"
                                >
                              ...
                              <>
                                ...
                                <div className="flex items-center gap-2">
                                  <button
                                    type="button"
                                    onClick={() => handleToggleStatus(designation.id, designation.name, designation.isActive)}
                                  ...
                                  <button
                                    type="button"
                                    onClick={() => handleStartEdit(designation.id, designation.name)}
